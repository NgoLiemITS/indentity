...
import com.devteria.identityservice.dto.request.RoleUserUpdateRequest;
...
public class UserService {
    ...
    public UserResponse creteUserByAdmin(UserCreationRequest request) {
        if (userRepository.existsByUsername(request.getUsername())) throw new AppException(ErrorCode.USER_EXISTED);
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public UserResponse updateRoles(String userId, RoleUserUpdateRequest request) {
        User user = userRepository.findById(userId).orElseThrow(() -> new AppException(ErrorCode.USER_NOT_EXISTED));
